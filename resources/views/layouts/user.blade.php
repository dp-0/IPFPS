    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown user user-menu">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ $user->profile_photo_url }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">Alexander Pierce</span>
                    </a>
                    <ul class="dropdown-menu">

                        <li class="user-header">
                            <img src="{{ $user->profile_photo_url }}" class="img-circle" alt="User Image">
                            <p>
                                {{ ucfirst($user->name) }} - {{ ucfirst($user->utype) }}
                                <small>Created At: {{ $user->created_at->format('Y:m:d') }}</small>
                            </p>
                        </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                <x-application-logo alt="{{ config('app.name', 'Laravel') }}"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset($user->profile_photo_path) }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
