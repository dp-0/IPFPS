<ul class="no-print navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
    ...
    <li
        ...
        <div id="fir"
            class="collapse {{ Request::is('admin/fir/view/*') || Request::is('fir/similarity/*') || Request::is('admin/fir-list', 'admin/fir/new', 'admin/incident-type', 'admin/case-priority', 'admin/fir-status') ? 'show' : '' }}"
            aria-labelledby="fir" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ Request::is('admin/fir/view/*') || Request::is('fir/similarity/*') || Request::is('admin/fir-list','admin/fir/new') ? 'active' : '' }}"
